    ...
    static init(app: Express) {
        ...
        app.get('/api/makeABooking', async (req: Request, res: Response) => {
            ...
            let ret: MakeABookingResponse = {
                ...
                pastBookingsTotalTimeMins: Math.floor(pastBookingsTotalTimeMins),
                inProgressBookingsTotalTimeMins: Math.floor(inProgressBookingsTotalTimeMins),
                cooldownRemainingMins: Math.floor(cooldownRemainingMins),
